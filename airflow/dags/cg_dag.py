...
body = {
  ...
  "jar": "https://fsd-uw2.xyzitc.com/artifactory/maven-spark-no-moonbeam-batch-example-release/com/xyz/platform/spark-no-moonbeam-batch-example/1.0/spark-no-moonbeam-batch-example-1.0.jar",
